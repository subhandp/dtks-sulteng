        ...
        <div class="box">
            ...
            <div class="row">
                ...
                <h5>
                    ...
                    <strong>Daftar FCSR</strong>
                    <span class="float-right">
                        
                        <a class="btn btn-warning btn-sm my-1 mr-sm-1" href="{{ route('psks.fcsr.create') }}" role="button" data-toggle="tooltip" title="Rekam data baru" data-offset="50%, 3"><i class="fas fa-edit"></i> Rekam</a>
                    </span>
                </h5>
                ...
                <table id="tabel-data-psks" class="table table-bordered data-table display compact">
                    <thead>
                        <tr>
                            ...
                            <th>JMLH CSR KESOS PERUSAHAAN</th>
 ...
 <script>
    ...
    $('#kabupaten_kota').select2({
     ...
     var table = $('#tabel-data-psks').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('psks.fcsr.datatables') }}",
            data: function (d) {
        ...
        columns: [
            ...
            {data: 'nama_fcsr', name: 'nama_fcsr'},
            {data: 'desa_kelurahan', name: 'desa_kelurahan'},
            {data: 'kecamatan', name: 'kecamatan'},
            {data: 'no_hp', name: 'no_hp'},
            {data: 'email', name: 'email'},
            {data: 'nama_ketua_pengurus_fcsr', name: 'nama_ketua_pengurus_fcsr'},
            {data: 'legalitas_fcsr', name: 'legalitas_fcsr'},
            {data: 'jumlah_pengurus', name: 'jumlah_pengurus'},
            {data: 'jumlah_anggota', name: 'jumlah_anggota'},
            {data: 'jumlah_csr_kesos_perusahaan', name: 'jumlah_csr_kesos_perusahaan'},
