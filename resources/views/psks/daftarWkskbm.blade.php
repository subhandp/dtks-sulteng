        ...
        <div class="box">
            ...
            <div class="row">
                ...
                <h5>
                    ...
                    <strong>Daftar WKSKBM</strong>
                    <span class="float-right">
                        
                        <a class="btn btn-warning btn-sm my-1 mr-sm-1" href="{{ route('psks.wkskbm.create') }}" role="button" data-toggle="tooltip" title="Rekam data baru" data-offset="50%, 3"><i class="fas fa-edit"></i> Rekam</a>
                    </span>
                </h5>
 ...
 <script>
    ...
    $('#kabupaten_kota').select2({
     ...
     var table = $('#tabel-data-psks').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('psks.wkskbm.datatables') }}",
            data: function (d) {
        ...
        columns: [
            ...
            {data: 'nama_wksb', name: 'nama_wksb'},
            {data: 'desa_kelurahan', name: 'desa_kelurahan'},
            {data: 'kecamatan', name: 'kecamatan'},
            {data: 'no_hp', name: 'no_hp'},
            {data: 'email', name: 'email'},
            {data: 'nama_ketua_wksbm', name: 'nama_ketua_wksbm'},
            {data: 'legalitas_wksbm', name: 'klasifikasi_wksbm'},
