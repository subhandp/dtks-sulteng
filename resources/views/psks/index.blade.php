...
@section('content')
        ...
        <div class="box">
            ...
            <div class="row">
                ...
                <h5>
                    ...
                    <strong>Import Data PSKS </strong>
            ...
            <div class="row table-responsive">
                ...
                <table class="table table-hover table-head-fixed" id="tabel-import-data" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @foreach($data_psks_import as $key => $import)
                        @php
                             $no++;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <strong><h5 class="modal-title w-100 text-center">Import Data PSKS</h5></strong>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/psks/store-import" method="POST" enctype="multipart/form-data" id="myForm" class="needs-validation" novalidate>
                            {{csrf_field()}}
                            <div class="container">
                                
                                <div class="form-group row">
                                    <label for="jenis_psks" class="col-sm-3 col-form-label">Jenis psks</label>
                                    <div class="input-group col-sm-9">

                                        <select class="@error('jenis_psks') is-invalid @enderror" id="jenis_psks" name="jenis_psks"  data-placeholder="Pilih Jenis PSKS" style="width: 100%"  >
                                            @foreach ($jenisPsks as $psks)
                                            @if (old('jenis_psks') == $psks->jenis )
                                                <option value="{{ $psks->jenis }}" selected="selected">
                                                    {{ $psks->jenis }}
                                                </option>
                                            @else
                                            
                                                <option value="{{ $psks->jenis }}">
                                                    {{ $psks->jenis }}
                                                </option>
                                            @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">Kab/Kota</label>
                                    <div class="col-lg-9">
                                        <select class="form-control @error('kabupaten_kota') is-invalid @enderror" id="kabupaten_kota" name="kabupaten_kota" data-placeholder="Pilih Kabupaten/Kota" style="width: 100%" >
                                            ...
                                            @if (old('kabupaten_kota') == $kabKota->name )
                                                <option value="{{ $kabKota->id }}" selected="selected">
                                                    {{ $kabKota->name }}
                                                </option>
                                            @else
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="smallBody">
                    ...
                    <div id="wrapper-table-psks">
                        <table class="table table-bordered" id="table-psks">
                            <thead>
                              <tr>
                                <th>IDDTKS</th>
 ...
 <script>
    ...
    var tablepsks = $('#table-psks').DataTable();
